...
def installation = new SonarInstallation(name, serverUrl, credentialsId, null, webhookSecretId, mojoVersion, additionalProperties, additionalAnalysisProperties, new TriggersConfig(skipScmCause, skipUpstreamCause, envVar))
